...
CEFR レベルのみを与えるベースラインに加え，Can-Do Statement，Can't-Do Statement や語彙レベル制限を組み合わせた複数条件を設定し，PS および QDP により回答挙動を評価した結果，一部条件で局所的な改善は確認されたものの，全体としては人間受験者に見られる正答率の段階的変化を安定的に再現するには至らなかった．
